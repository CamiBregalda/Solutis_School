...
public class Main {
    ...
    private static void pesquisarAnimal(List<AnimalAB> listaAnimais){
        ...
        if (animalEncontrado == null) {
            ...
            if (animalEncontrado instanceof Pombo) {
                Pombo pombo = (Pombo) animalEncontrado;
            ...
            } else if (animalEncontrado instanceof AnimalTerrestreAB) {
                AnimalTerrestreAB animalTerrestre = (AnimalTerrestreAB) animalEncontrado;
    ...
    private static AnimalAB checarNome(String nome, List<AnimalAB> animaisCadastrados){
        AnimalAB animalEncontrado = animaisCadastrados.stream()
                .filter(animal -> animal.nome.equalsIgnoreCase(nome))
                .findFirst()
                .orElse(null);
    ...
    private static AnimalAB criarAnimalTerrestre(String animal, String nome, int idade, double altura, double peso, int quantPatas, double quantidadeComida, double distanciaPercurso, double horasSono){
